    ...
    <section ref={sectionRef} className="relative py-24 px-4 overflow-hidden">
      ...
      <div className="relative max-w-2xl mx-auto text-center">
        <div className="space-y-8">
            ...
            {!isSubmitted ? (
              <>
                <Input
                  ...
                  className="h-14 px-5 bg-white/10 border-white/20 text-white placeholder:text-white/40 rounded-xl text-base backdrop-blur-sm focus-visible:border-blue-400 focus-visible:ring-blue-400/20"
                  required
                />
                <Button
                  type="submit"
              ...
              <div className="flex items-center gap-3 px-5 py-4 bg-emerald-500/20 text-emerald-200 rounded-xl border border-emerald-400/30 w-full justify-center backdrop-blur-sm">
          ...
          {error && (
            <div className="flex items-center gap-2 rounded-xl bg-red-500/20 px-4 py-3 text-red-200 ring-1 ring-red-400/30 max-w-md mx-auto animate-fade-in-up backdrop-blur-sm" role="alert">
